...
// ((Base Projectile Damage * Weapon Damage Projectile Multiplier) - max(armor_maximum, (Armor - (Penetration Power * Weapon Projectile Penetration Multiplier)))) * Wound Scale = Result Damage
