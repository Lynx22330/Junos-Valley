...
/mob/living/carbon/superior_animal/roach/fuhrer
	...
	turns_per_move = 4
	maxHealth = 200 * ROACH_HEALTH_MOD
	health = 200 * ROACH_HEALTH_MOD          // Tanky leader, meant to give them time to actually make calls and get backup.

	knockdown_odds = 5
	melee_damage_lower = 8
	melee_damage_upper = 12   // Somewhat strong, somewhat weak. They are a leader, not a fighter.
	move_to_delay = 8
	mob_size = MOB_MEDIUM
	...
	armor = list(melee = 4, bullet = 2, energy = 0, bomb = 0, bio = 40, rad = 0, agony = 0)
	armor_divisor = 1.25
