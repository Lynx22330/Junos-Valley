...
/obj/item/projectile/beam/musket
	name = "Musket laser"
	armor_penetration = 2.5 //Good AP, its for slow firing weapon
	eyeblur = 1
	damage_types = list(BURN = 25) //According to Rain Chule recommendation

/obj/item/projectile/beam/drone
	damage_types = list(BURN = 15)
	armor_penetration = 1.1 //Some AP
	recoil = 2

/obj/item/projectile/beam/pulse/drone
	damage_types = list(BURN = 10)
	armor_penetration = 1 //No AP we deal 30 damage in 3 shots

/obj/item/projectile/beam/weak
	damage_types = list(BURN = 16)
	armor_penetration = 1.15 //Some AP
	recoil = 2
...
/obj/item/projectile/beam/weak/lethal
	damage_types = list(BURN = 20)
	armor_penetration = 1 //cant have negitive armor sadly
...
/obj/item/projectile/beam/pulse
	...
	armor_penetration = 2 //it's a pulse blast.
	wounding_mult = 1.5
	eyeblur = 4
	recoil = 3
...
/obj/item/projectile/beam/radiation
	...
	icon_state = "emitter"
	damage_types = list(BURN = 40)
	armor_penetration = 1.75 //Experimental and extremely rare but also self recharging so take it as you will
	recoil = 7
...
/obj/item/projectile/beam/IRKdissolver //Marking this for future use with IRK
	...
	armor_penetration = 4 //Experimental and extremely rare but also self recharging so take it as you will
...
/obj/item/projectile/beam/infrared
	...
	damage_types = list(BURN = 15)
	armor_penetration = 1.25 //less ap
	eyeblur = 0
	muzzle_type = null
	tracer_type = null
	impact_type = null
